...
export default function PricingPage() {
  ...
  const handleStripeRedirect = async (type: 'plan' | 'credits', planName?: string | null) => {
    try {
      console.log(`Redirecting to Stripe for ${type}...`)
          ...
          <div className="grid md:grid-cols-5 gap-6 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><button onClick={() => router.push('/pricing')} className="hover:text-white">{tFooter('pricing')}</button></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><button onClick={() => router.push('/legal/terms')} className="hover:text-white">{tFooter('termsOfService')}</button></li>
                <li><button onClick={() => router.push('/legal/privacy')} className="hover:text-white">{tFooter('privacyPolicy')}</button></li>
                <li><button onClick={() => router.push('/legal/cookie')} className="hover:text-white">{tFooter('cookiePolicy')}</button></li>
              </ul>
            </div>
          </div>
